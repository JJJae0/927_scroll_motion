...
// baseLine 은 박스의 모션 시작시점을 기존 박스 영역에서 300만큼 위로 올림
const baseLine = -300;

window.addEventListener('scroll', () => {
	const scroll = window.scrollY;
	// 박스에 실 적용되는 스크롤 수치값을 반대로 300 만큼 더해줘야됨
	...
	// 스크롤거리값이 2번째 섹션영역에 들어가면 scroll_2에는 scroll 적용되는 값을 담고
	// 반대로 2번째 섹션영역을 벗어나면 scroll_2 의 값을 0 으로 초기화
